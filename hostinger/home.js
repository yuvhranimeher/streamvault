(function(){
  ...
  function svFetchHomeFeed(limit){
    ...
    svHomePayloadPromise = fetch('/home-feed.json?v=20260620-player-tracks-sections-final1', { cache:'force-cache' })
      .then(readJson)
      .catch(()=>fetch(`https://streamvault.fit(https://streamvault.fithttps://streamvault.fit/api/home-feed?limit=${requestedLimit}`).then(readJson))
      .then(data=>{
  ...
  function svFetchHomeSection(meta, options={}){
    ...
    return fetch(`https://streamvault.fit(https://streamvault.fithttps://streamvault.fit/api/section/${encodeURIComponent(meta.sectionKey)}?page=0&limit=${limit}&summary=${summary}&v=20260620-player-tracks-sections-final1`)
  ...
  function svFifaBuildDetailUrl(match){
    ...
    return `https://streamvault.fit(https://streamvault.fithttps://streamvault.fit/api/fifa-live/match/${provider}/${id}${params.toString() ? `?${params}` : ''}`;
  }
  ...
  function svFetchFifaNews(background){
    ...
    fetch('https://streamvault.fithttps://streamvault.fit(https://streamvault.fithttps://streamvault.fit/api/fifa-live/news', {
      cache:'no-store',
      headers:{ Accept:'application/json' },
  ...
  function svFifaLiveFetchUrl(){
    ...
    return `https://streamvault.fit(https://streamvault.fithttps://streamvault.fit/api/fifa-live?${params.toString()}`;
  }
  ...
  window.openHomeSection = function(rowId){
    ...
    fetch(`https://streamvault.fit(https://streamvault.fithttps://streamvault.fit/api/section/${encodeURIComponent(meta.sectionKey)}?page=0&limit=${SV_HOME_ROW_LIMIT}&summary=0`)
      .then(r=>r.json())
      .then(data=>{
  ...
  window.svLoadMoreSection = function(){
    ...
    fetch(`https://streamvault.fit(https://streamvault.fithttps://streamvault.fit/api/section/${encodeURIComponent(svSectionState.key)}?page=${nextPage}&limit=${SV_HOME_ROW_LIMIT}&summary=0`)
      .then(r=>r.json())
      .then(data=>{
  ...
  function svEnsureLiveMatchChannels(){
    ...
    svLiveMatchChannelsPromise = fetch('https://streamvault.fithttps://streamvault.fit(https://streamvault.fithttps://streamvault.fit/api/channels', { cache:'no-store' })
