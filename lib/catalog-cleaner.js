...
const { dedupeCatalog, mergeSeriesSeasons, mergeSources, selectBestSource, sourceForItem, sourceHost } = require('./catalog-dedupe');
...
function cleanOne(raw, options = {}) {
  ...
  const seasons = type === 'series' ? mergeSeriesSeasons(merged.seasons) : [];
