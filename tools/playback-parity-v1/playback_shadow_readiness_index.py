...
GATES = [
    ...
    "inactive_playback_route_response_body_js_vs_hs_compare.py",
...
REPORTS = [
    ...
    ("inactive_route_response_body_compare_report", "inactive-playback-route-response-body-js-vs-hs-report-*.txt"),
    ...
    ("inactive_route_implementation_shadow_compare_report", "inactive-playback-route-implementation-shadow-js-vs-hs-report-*.txt"),
    ("inactive_route_implementation_shadow_envelope_report", "inactive-playback-route-implementation-shadow-envelope-report-*.txt"),
    ("inactive_route_implementation_shadow_fixture_coverage_report", "inactive-playback-route-implementation-shadow-fixture-coverage-report-*.txt"),
    ("inactive_route_implementation_shadow_safety_report", "inactive-playback-route-implementation-shadow-safety-report-*.txt"),
    ("inactive_route_implementation_shadow_report", "inactive-playback-route-implementation-shadow-report-*.txt"),
