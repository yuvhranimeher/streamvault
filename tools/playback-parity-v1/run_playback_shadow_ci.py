...
GATES = [
    ...
    ("inactive_route_error_taxonomy_js_vs_hs_compare", TOOL_DIR / "inactive_playback_route_error_taxonomy_js_vs_hs_compare.py"),
    ("inactive_route_error_taxonomy_envelope_gate", TOOL_DIR / "inactive_playback_route_error_taxonomy_envelope_gate.py"),
    ("inactive_route_error_taxonomy_fixture_coverage_audit", TOOL_DIR / "inactive_playback_route_error_taxonomy_fixture_coverage_audit.py"),
    ("inactive_route_error_taxonomy_safety_gate", TOOL_DIR / "inactive_playback_route_error_taxonomy_safety_gate.py"),
    ("inactive_route_implementation_shadow_js_vs_hs_compare", TOOL_DIR / "inactive_playback_route_implementation_shadow_js_vs_hs_compare.py"),
    ("inactive_route_implementation_shadow_envelope_gate", TOOL_DIR / "inactive_playback_route_implementation_shadow_envelope_gate.py"),
    ("inactive_route_implementation_shadow_fixture_coverage_audit", TOOL_DIR / "inactive_playback_route_implementation_shadow_fixture_coverage_audit.py"),
    ("inactive_route_implementation_shadow_safety_gate", TOOL_DIR / "inactive_playback_route_implementation_shadow_safety_gate.py"),
    ("inactive_route_implementation_shadow_report", TOOL_DIR / "inactive_playback_route_implementation_shadow_report.py"),
    ("inactive_route_final_readiness_js_vs_hs_compare", TOOL_DIR / "inactive_playback_route_final_readiness_js_vs_hs_compare.py"),
    ("inactive_route_final_readiness_safety_gate", TOOL_DIR / "inactive_playback_route_final_readiness_safety_gate.py"),
    ("inactive_route_final_readiness_report", TOOL_DIR / "inactive_playback_route_final_readiness_report.py"),
    ("inactive_route_activation_plan_prerequisites", TOOL_DIR / "inactive_playback_route_activation_plan_prerequisites.py"),
    ("inactive_route_activation_plan_dependency_checker", TOOL_DIR / "inactive_playback_route_activation_plan_dependency_checker.py"),
    ("inactive_route_activation_plan_safety_gate", TOOL_DIR / "inactive_playback_route_activation_plan_safety_gate.py"),
    ("inactive_route_activation_plan_report", TOOL_DIR / "inactive_playback_route_activation_plan_report.py"),
